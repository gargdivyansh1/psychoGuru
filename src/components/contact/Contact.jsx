...
import { Mail, Phone, MapPin, Send, Clock, MessageSquare, User, HelpCircle, AlertCircle } from 'lucide-react';
...
function Contact() {
  ...
  return (
    <div className="bg-black text-white min-h-screen py-16 px-6 md:px-20 lg:px-32">
      ...
      >
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 pb-2">
      ...
      <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
        {/* Contact Form */}
        <motion.div
          className="bg-neutral-950 p-8 rounded-2xl shadow-lg border border-gray-800"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={handleBlur}
                  className={`w-full bg-neutral-900 text-white pl-10 pr-4 py-3 rounded-md placeholder-gray-500 focus:outline-none focus:ring-2 ${
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className={`w-full bg-neutral-900 text-white px-4 py-3 rounded-md placeholder-gray-500 focus:outline-none focus:ring-2 ${
        ...
        >
          ...
          <div className="bg-neutral-950 p-8 rounded-2xl shadow-lg border border-gray-800">
            <div className="flex items-center gap-3 mb-6">
          ...
          <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 p-6 rounded-2xl shadow-lg border border-purple-900/30">
